...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <form method="post" class="d-block w-50 mx-auto mt-5" action="{{route('store.timelimit')}}">
       @csrf
       ...
       <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <div class="d-flex align-items-center">
                <input  class="form-control" id="limit" name="limit"placeholder="0"> 
                <p class="my-0 ms-5">Menit</p>
            </div>
        </div>
